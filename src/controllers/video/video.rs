...
// /// # Name - media_codecs
// /// # Description - List of codecs that SFU will accept from clients
// /// # Parameters - None
// /// # Return - Vector of RtpCodecCapability
// /// # Example - media_codecs()
...
// impl StreamVideo {
//     /// # Name - StreamVideo::new
//     /// # Description - Create a new instance representing WebSocket connection from the client
//     /// # Arguments
//     /// * `router` - Router associated with this client, useful to get its RTP capabilities later
//     /// * `worker_manager` - Worker manager to create new worker and router
//     /// # Returns
//     /// * `Result<Self, String>` - Result of creating a new instance
//     /// # Errors
//     /// * `String` - Error message
//     /// # Example
//     /// ```
//     /// let worker_manager = WorkerManager::new().await?;
//     /// let router = worker_manager.create_router(RouterOptions::default()).await?;
//     /// let stream_video = StreamVideo::new(router, worker_manager).await?;
//     /// 
//     /// // assert that the router is the same
//     /// assert_eq!(stream_video.router.id(), router.id());
//     /// // assert the stream_video has no consumers
//     /// assert_eq!(stream_video.consumers.len(), 0);
//     /// ```
//     /// # Remarks
//     /// This method is async, so you need to await it.
...
// impl StreamHandler<Result<ws::Message, ws::ProtocolError>> for StreamVideo {
...
// impl Handler<ClientMessage> for StreamVideo {
//     type Result = ();
...
// impl Handler<ServerMessage> for StreamVideo {
//     type Result = ();
...
// impl Handler<InternalMessage> for StreamVideo {
//     type Result = ();
...
//     match StreamVideo::new(&worker_manager).await {
